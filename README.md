...
.env переименован в .enx.txt для удобства просмотра
внутри
DATABASE_URL=postgresql://user:pass@localhost/webhook_db
AI_AGENT_API_KEY=тут какой то API ключ агента
AI_AGENT_URL=опять какой то URL
